...
- [emitOnAllTabs](/docs/api/props#emitonalltabs): Emit events on all tabs. By default only the leader tab emits callbacks.
...
{/* cspell:disable */}
- [isLeader()](/docs/api/methods#isleader): Returns true if this is the leader tab.
