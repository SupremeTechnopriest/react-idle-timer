...
{/* cspell:disable */}
- [crossTab](/docs/props#crosstab): Enables the cross tab feature.
- [emitOnAllTabs](/docs/props#emitonalltabs): Emit events on all tabs. By default only the leader tab emits callbacks.
- [onMessage](/docs/props#onprompt): Function called when a message is received.
{/* cspell:enable */}
...
{/* cspell:disable */}
- [isLeader()](/docs/methods#isleader): Returns true if this is the leader tab.
- [message()](/docs/methods#message): Broadcast a message to all tabs.
{/* cspell:enable */}
