...
results. To combat this, all timers in v5 have been moved to a WebWorker to keep 
them alive when a window is throttled by the browser. The worker is provided via 
...
accurate. If this is not an option, you can enable native timers by 
