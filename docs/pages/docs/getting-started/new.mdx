...
Events are emitted on all tabs by default and leader election has been removed.
Leader election was rarely used and is not compatible with the new IdleTimer
features.
